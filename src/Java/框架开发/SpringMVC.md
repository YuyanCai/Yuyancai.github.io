...
![image-20220119121539011](https://typora-1259403628.cos.ap-nanjing.myqcloud.com/image-20220119121539011.png)
...
![image-20220118111808663](https://typora-1259403628.cos.ap-nanjing.myqcloud.com/image-20220118111808663.png)





![image-20220118150915376](https://typora-1259403628.cos.ap-nanjing.myqcloud.com/image-20220118150915376.png)
...
![image-20220118151040616](https://typora-1259403628.cos.ap-nanjing.myqcloud.com/image-20220118151040616.png)
...
![image-20220119120333401](https://typora-1259403628.cos.ap-nanjing.myqcloud.com/image-20220119120333401.png)
...
![image-20220119163154550](https://typora-1259403628.cos.ap-nanjing.myqcloud.com/image-20220119163154550.png)
...
![image-20220119163538899](https://typora-1259403628.cos.ap-nanjing.myqcloud.com/image-20220119163538899.png)
...
![image-20220311085644518](https://typora-1259403628.cos.ap-nanjing.myqcloud.com/image-20220311085644518.png)

**这个注解很重要，后面当用户提交表单的时候，用此注解进行参数绑定生成对象进行判断保存到数据库等操作**



## 9、@PathParam

> 我们使用@PathParam注解进行占位符的匹配获取工作。
>
> 这个注解也很重要！当我们后面对数据进行编辑删除操作的时候，我们要实现点击按钮删除对应的数据，那么如何实现这个功能呢？给按钮设置id，点击按钮的时候路径就会出现id，那么我们就获得这个id，之后通过sql语句进行按id删除，编辑即可

![image-20220311085900078](https://typora-1259403628.cos.ap-nanjing.myqcloud.com/image-20220311085900078.png)
...
```
地址栏中的请求地址
[localhost/quick13?username=zs&age=13](http://localhost/quick13?username=zs&age=13)


最终结果
User{username='zs', age=13}
```
...
```java
    ...
    @ResponseBody
    public void save13(String name, MultipartFile uploadFile) throws IOException {
//        获得文件名称
        String originalFilename = uploadFile.getOriginalFilename();
//        保存文件
        uploadFile.transferTo(new File("D:\\BaiduNetdiskDownload\\"+originalFilename));
    }
```
...
![image-20220119235028904](https://typora-1259403628.cos.ap-nanjing.myqcloud.com/image-20220119235028904.png)
...
```xml
<bean class="com.caq.interceptor.FirstInterceptor"></bean>
...
@Configuration
//扫描组件
@ComponentScan("com.caq.mvc.controller")
//开启MVC注解驱动
@EnableWebMvc
